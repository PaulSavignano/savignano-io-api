...
brands.patch('/:brandName/:_id/articlestyle', authenticate(['admin']), updateArticleStyle)
...
brands.patch('/:brandName/:_id/herostyle', authenticate(['admin']), updateHeroStyle)
brands.patch('/:brandName/:_id/palette', authenticate(['admin']), updatePalette)
brands.patch('/:brandName/:_id/productstyle', authenticate(['admin']), updateProductStyle)
brands.patch('/:brandName/:_id/typography', authenticate(['admin']), updateTypography)
